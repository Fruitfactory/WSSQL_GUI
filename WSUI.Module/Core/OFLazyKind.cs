...
{
    public class OFLazyKind : ILazyKind, INotifyPropertyChanged
    {
        ...
        public OFLazyKind(IUnityContainer container, Type typeKind, IMainViewModel parent, Action<object> choose, Action<string> propertychanged)
        {
