...
{
    public abstract class OFBasePreviewCommand : IOFCommand
    {
        protected IMainViewModel MainViewModel;

        protected OFBasePreviewCommand(IMainViewModel mainViewModel)
        {
        ...
        protected OFBaseSearchObject GetCurrentSearchObject()
        {
            return MainViewModel.IsPreviewVisible ? MainViewModel.Current : MainViewModel.CurrentTracked;
        }

        protected OFTypeSearchItem GetTypeOfCurrentItem()
        {
