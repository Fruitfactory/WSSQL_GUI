...
namespace OF.Module.Service
{
    ...
    public class OFDateToStringConverter : IValueConverter
    {
    ...
    [ValueConversion(typeof(OFBaseSearchObject), typeof(string))]
    public class ObjectToNameConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            var contact = value as OFContactSearchObject;
            if (contact != null)
            {
            ...
            var email = value as OFEmailContactSearchObject;
            if (email != null)
            {
