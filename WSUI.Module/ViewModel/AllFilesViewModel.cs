...
{
    [KindNameId(OFKindsConstName.Everything, 0, @"pack://application:,,,/OF.Module;Component/Images/View.png", @"M33.597977,10.759002C37.946865,10.759002 41.485962,14.285001 41.485962,18.649 41.485962,23 37.946865,26.535 33.597977,26.535 29.23909,26.535 25.709992,23 25.709992,18.649 25.709992,17.784 25.849955,16.953001 26.109888,16.174002 26.779719,16.881001 27.70948,17.327002 28.759213,17.327002 30.778696,17.327002 32.418278,15.691001 32.418278,13.668001 32.418278,12.663001 32.008381,11.748001 31.348551,11.087002 32.058369,10.876001 32.818176,10.759002 33.597977,10.759002z M33.606682,4.3679962C25.92741,4.3679957 19.698065,10.594956 19.698065,18.27293 19.698065,25.953894 25.92741,32.177862 33.606682,32.177862 41.295838,32.177862 47.515175,25.953894 47.515175,18.27293 47.515175,10.594956 41.295838,4.3679957 33.606682,4.3679962z M34.867642,1.546141E-09C36.890393,2.6508449E-05 58.705193,0.41938579 68.893006,18.299923 68.893006,18.299923 57.1442,36.139837 34.44656,34.768854 34.44656,34.768854 14.428583,36.59984 0,18.299923 0,18.299923 9.0791523,0.4590019 34.716553,0.0010111886 34.716553,0.0010114873 34.768162,-1.4442128E-06 34.867642,1.546141E-09z")]
    public class AllFilesViewModel : OFKindViewModelBase, IUView<AllFilesViewModel>
    {
            ...
            : base(container, eventAggregator)
        {
            ...
            SearchSystem = new OFAllSearchSystem();
        ...
        {
            var data = obj as OFExpanderData;
            if (data == null)
            {
                return;
            }
            ...
            {
                EmailHeight += restDelta > delta ? delta : restDelta < 0 && avaibleHeight > AvaregeTwoRowItemHeight ? avaibleHeight : restDelta > 0 ? restDelta : 0;
        ...
        {
            if (!(obj is OFCommandSearchObject))
                return false;
            Parent.SelectKind(OFKindsConstName.People);
            return true;
        }
        ...
        {
            base.OnInit();
            ScrollBehavior = new OFScrollBehavior { CountFirstProcess = 300, CountSecondProcess = 100, LimitReaction = 99 };
