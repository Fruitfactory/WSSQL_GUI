...
namespace WSPreview.PreviewHandler
{
    ...
    public class ShadowDrawing
    {
        ...
        static Image shadowDownLeft = new Bitmap(Resources.tshadowdownleft);
        static Image shadowDown = new Bitmap(Resources.tshadowdown);
        static Image shadowRight = new Bitmap(Resources.tshadowright);
        static Image shadowTopRight = new Bitmap(Resources.tshadowtopright);
