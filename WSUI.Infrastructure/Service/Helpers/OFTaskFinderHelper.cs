...
{
    internal class OFTaskFinderHelper
    {
        #region fields
        ...
        private static OFTaskFinderHelper _instance = null;

        #endregion

        private OFTaskFinderHelper()
        {
            LoadAllTasks();
        }
        ...
        public static OFTaskFinderHelper Instance
        {
            get
            {
                lock (_lock)
                {
                    if(_instance == null)
                        _instance = new OFTaskFinderHelper();
                    return _instance;
                }
            }
        }
