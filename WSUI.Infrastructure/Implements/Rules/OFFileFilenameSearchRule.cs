...
{
	public class OFFileFilenameSearchRule : OFBaseFileSearchRule
	{

        public OFFileFilenameSearchRule(IUnityContainer container)
            :this(null,container)
		{
		    ConstructorInit();
		}

        public OFFileFilenameSearchRule(object lockObject, IUnityContainer container)
	    ...
	    protected override IEnumerable<OFFileSearchObject> GetSortedFileSearchObjects(IEnumerable<OFFileSearchObject> list)
	    {
