...
{
    public class OFHightliteTextBlockBase : ContentControl
    {
        private string _text = string.Empty;

        protected OFHightliteTextBlockBase()
        {
        }
        ...
        public static readonly DependencyProperty BackgroundColorProperty =
          DependencyProperty.Register("BackgroundColor", typeof(Color), typeof(OFHightliteTextBlockBase),
        ...
        public static readonly DependencyProperty TextProperty =
          DependencyProperty.Register("Text", typeof(string), typeof(OFHightliteTextBlockBase), new UIPropertyMetadata(string.Empty, UpdateControlCallBack));
        ...
        public static readonly DependencyProperty HightlightProperty =
          DependencyProperty.Register("Hightlight", typeof(string), typeof(OFHightliteTextBlockBase), new UIPropertyMetadata(string.Empty));
        ...
        {
            OFHightliteTextBlockBase obj = d as OFHightliteTextBlockBase;
        ...
        public static readonly DependencyProperty FontSizeLabelSizeProperty =
          DependencyProperty.Register("FontSizeLabel",
                                      typeof(double),
                                      typeof(OFHightliteTextBlockBase),
        ...
        protected override void OnRender(DrawingContext drawingContext)
        {
            ...
            var mCol = OFHelperFunctions.GetMatches(_text, Hightlight); //Regex.Matches(Text, string.Format(@"({0})", Regex.Escape(Hightlight)), RegexOptions.IgnoreCase);
            if (mCol.Count == 0)
            {
                ClearInlines();
                AddInline(GenerateRun(_text));
