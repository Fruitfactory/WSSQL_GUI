...
{
    public class OFChildListBoxBehavior : Behavior<ListBox>
    {
        ...
        private void AssociatedObjectOnSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                OFListBoxShouldSetSelectAttachedProperty.SetShouldSetSelect(Parent, false);
                Parent.SelectedIndex = _parentIndex;
                OFListBoxSelectedObjectAttachedProperty.SetSelectedObject(Parent, AssociatedObject.SelectedItem);
                OFListBoxShouldSetSelectAttachedProperty.SetShouldSetSelect(Parent, true);
            }
        }
