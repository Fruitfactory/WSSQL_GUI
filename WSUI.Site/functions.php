...
function wpcf7_generate_Lime_Key_posted_data( $posted_data ) {
    ...
    $xml = new SimpleXMLElement(LimeLM::GeneratePKeys($LimeLM_VersionID, 1, 1, $emailCustomer,array( $trial_field,$email_field), array($trialDate,$emailCustomer)));
    ...
    Your trial product key is:

' . $product_keys . '

This product key is licensed for ' . $quantity . ( $quantity > 1 ? ' users' : ' user' ) . ' of ' . $AppName . ' for ' . 14 . ' days.
