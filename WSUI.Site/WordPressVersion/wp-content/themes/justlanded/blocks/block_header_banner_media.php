        <?php if ($data['banner_position'] == "right") $last=" last"; else $last = ""; ?>
        <?php if ($data['banner_layout_select'] == "Single Image") { ?>
        <!--Start Product Image-->
        <?php if(!function_exists('justlanded_banner_media_image')) { ?>
        <div id="banner_image" class="one_half<?php echo $last; ?>">
        ...
        <div id="banner_free_content" class="one_half<?php echo $last; ?>">
