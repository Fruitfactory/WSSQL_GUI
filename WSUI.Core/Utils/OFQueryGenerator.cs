...
{
    public class OFQueryGenerator : IQueryGenerator
    {
        ...
        {
            var listFields = OFFieldCash.Instance.GetFieldList(type);
        ...
        private string GenerateWherePart(IRuleQueryGenerator ruleQueryGenerator)
        {
            if (ruleQueryGenerator == null)
                return "";
            string where = ruleQueryGenerator.GenerateWherePart(OFRuleFactory.Instance.GetAllRules());
            return where;
        }
