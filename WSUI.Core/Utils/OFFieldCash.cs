...
{
    public class OFFieldCash : IFieldCash
    {
        ...
        private void Init()
        {
            AddType(typeof(OFAttachmentSearchObject));
            AddType(typeof(OFEmailSearchObject));
            AddType(typeof(OFFileSearchObject));
            AddType(typeof(OFContactSearchObject));
            AddType(typeof(OFEmailContactSearchObject));
        }
        ...
        private OFFieldAttribute GetAttribute(PropertyInfo pi)
        {
            var propertyInfos = pi.GetCustomAttributes(typeof(OFFieldAttribute), false);
            return (OFFieldAttribute)(propertyInfos.Length > 0 ? propertyInfos[0] : null);
        }
