...
namespace WSSQLGUI
{
    class Logic
    {
        ...
        public static OleDbDataReader ExecuteQuery(string query, int chapterDepth)
        {
            ...
            catch (System.Data.OleDb.OleDbException oleDbException)
            {
                ...
                {
                    Console.WriteLine("\tError " + i.ToString(System.Globalization.CultureInfo.CurrentCulture.NumberFormat) + "\n" +
                                      "\t\tMessage: " + oleDbException.Errors[i].Message + "\n" +
                                      "\t\tNative: " + oleDbException.Errors[i].NativeError.ToString(System.Globalization.CultureInfo.CurrentCulture.NumberFormat) + "\n" +
